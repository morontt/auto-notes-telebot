...
abstract class FuelRepositoryAbstractClient
{
     ...
     * {@inheritdoc}
     */
    public function GetFuels(array $ctx, \AutoNotes\Limit $in): \AutoNotes\FuelCollection
    {
        ...
        $out = new \AutoNotes\FuelCollection();
     ...
     * {@inheritdoc}
     */
    public function GetFillingStations(array $ctx, \Google\Protobuf\GPBEmpty $in): \AutoNotes\FillingStationCollection
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes');
        $ctx = Context::withServiceName($ctx, 'FuelRepository');
        $ctx = Context::withMethodName($ctx, 'GetFillingStations');

        $out = new \AutoNotes\FillingStationCollection();
     ...
     * {@inheritdoc}
     */
    public function SaveFuel(array $ctx, \AutoNotes\Fuel $in): \AutoNotes\Fuel
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes');
        $ctx = Context::withServiceName($ctx, 'FuelRepository');
        $ctx = Context::withMethodName($ctx, 'SaveFuel');

        $out = new \AutoNotes\Fuel();
