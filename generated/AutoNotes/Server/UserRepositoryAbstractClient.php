...
abstract class UserRepositoryAbstractClient
{
     ...
     * {@inheritdoc}
     */
    public function GetCars(array $ctx, \Google\Protobuf\GPBEmpty $in): \AutoNotes\Server\CarCollection
    {
        ...
        $out = new \AutoNotes\Server\CarCollection();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.UserRepository/GetCars';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.UserRepository/GetCars';
        }
     ...
     * {@inheritdoc}
     */
    public function GetCurrencies(array $ctx, \Google\Protobuf\GPBEmpty $in): \AutoNotes\Server\CurrencyCollection
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes.server');
        $ctx = Context::withServiceName($ctx, 'UserRepository');
        $ctx = Context::withMethodName($ctx, 'GetCurrencies');

        $out = new \AutoNotes\Server\CurrencyCollection();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.UserRepository/GetCurrencies';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.UserRepository/GetCurrencies';
        }
     ...
     * {@inheritdoc}
     */
    public function GetDefaultCurrency(array $ctx, \Google\Protobuf\GPBEmpty $in): \AutoNotes\Server\DefaultCurrency
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes.server');
        $ctx = Context::withServiceName($ctx, 'UserRepository');
        $ctx = Context::withMethodName($ctx, 'GetDefaultCurrency');

        $out = new \AutoNotes\Server\DefaultCurrency();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.UserRepository/GetDefaultCurrency';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.UserRepository/GetDefaultCurrency';
        }
     ...
     * {@inheritdoc}
     */
    public function GetUserSettings(array $ctx, \Google\Protobuf\GPBEmpty $in): \AutoNotes\Server\UserSettings
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes.server');
        $ctx = Context::withServiceName($ctx, 'UserRepository');
        $ctx = Context::withMethodName($ctx, 'GetUserSettings');

        $out = new \AutoNotes\Server\UserSettings();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.UserRepository/GetUserSettings';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.UserRepository/GetUserSettings';
        }
     ...
     * {@inheritdoc}
     */
    public function SaveUserSettings(array $ctx, \AutoNotes\Server\UserSettings $in): \AutoNotes\Server\UserSettings
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes.server');
        $ctx = Context::withServiceName($ctx, 'UserRepository');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.UserRepository/SaveUserSettings';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.UserRepository/SaveUserSettings';
        }
    ...
    protected function newRequest(array $ctx, string $url, string $reqBody, string $contentType): RequestInterface
    {
        ...
        return $req
            ...
            ->withHeader('TwirPHP-Version', '0.14.0')
        ;
    }
