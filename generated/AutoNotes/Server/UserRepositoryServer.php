 ...
 */
final class UserRepositoryServer implements
    ...
    ServerWithPathPrefix
{
     ...
     */
    public const PATH_PREFIX = '/twirp/xelbot.com.autonotes.server.UserRepository/';
    ...
    {
        return $this->prefix.'/xelbot.com.autonotes.server.UserRepository/';
    }
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        if ($service != 'xelbot.com.autonotes.server.UserRepository') {
    ...
    private function handleSaveUserSettingsJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \AutoNotes\Server\UserSettings();
            $in->mergeFromJsonString((string)$req->getBody(), true);
