...
abstract class FuelRepositoryAbstractClient
{
    ...
    public function GetFuels(array $ctx, \AutoNotes\Server\FuelFilter $in): \AutoNotes\Server\FuelCollection
    {
        ...
        $out = new \AutoNotes\Server\FuelCollection();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.FuelRepository/GetFuels';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.FuelRepository/GetFuels';
        }
     ...
     * {@inheritdoc}
     */
    public function FindFuel(array $ctx, \AutoNotes\Server\IdRequest $in): \AutoNotes\Server\Fuel
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes.server');
        $ctx = Context::withServiceName($ctx, 'FuelRepository');
        $ctx = Context::withMethodName($ctx, 'FindFuel');

        $out = new \AutoNotes\Server\Fuel();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.FuelRepository/FindFuel';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.FuelRepository/FindFuel';
        }
     ...
     * {@inheritdoc}
     */
    public function GetFillingStations(array $ctx, \Google\Protobuf\GPBEmpty $in): \AutoNotes\Server\FillingStationCollection
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes.server');
        $ctx = Context::withServiceName($ctx, 'FuelRepository');
        $ctx = Context::withMethodName($ctx, 'GetFillingStations');

        $out = new \AutoNotes\Server\FillingStationCollection();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.FuelRepository/GetFillingStations';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.FuelRepository/GetFillingStations';
        }
    ...
    public function SaveFuel(array $ctx, \AutoNotes\Server\Fuel $in): \AutoNotes\Server\Fuel
    {
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.FuelRepository/SaveFuel';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.FuelRepository/SaveFuel';
        }
