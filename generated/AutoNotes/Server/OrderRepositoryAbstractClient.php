...
/**
 * @internal OrderRepositoryAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class OrderRepositoryAbstractClient
{
    /**
     * @var string
     */
     ...
     * {@inheritdoc}
     */
    public function GetOrders(array $ctx, \AutoNotes\Server\OrderFilter $in): \AutoNotes\Server\OrderCollection
    {
        ...
        $out = new \AutoNotes\Server\OrderCollection();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.OrderRepository/GetOrders';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.OrderRepository/GetOrders';
        }
    ...
    public function GetOrderTypes(array $ctx, \Google\Protobuf\GPBEmpty $in): \AutoNotes\Server\OrderTypeCollection
    {
        ...
        $out = new \AutoNotes\Server\OrderTypeCollection();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.OrderRepository/GetOrderTypes';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.OrderRepository/GetOrderTypes';
        }
     ...
     * {@inheritdoc}
     */
    public function SaveOrder(array $ctx, \AutoNotes\Server\Order $in): \AutoNotes\Server\Order
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes.server');
        $ctx = Context::withServiceName($ctx, 'OrderRepository');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.OrderRepository/SaveOrder';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.OrderRepository/SaveOrder';
        }
     ...
     * {@inheritdoc}
     */
    public function GetExpenses(array $ctx, \AutoNotes\Server\ExpenseFilter $in): \AutoNotes\Server\ExpenseCollection
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes.server');
        $ctx = Context::withServiceName($ctx, 'OrderRepository');
        $ctx = Context::withMethodName($ctx, 'GetExpenses');

        $out = new \AutoNotes\Server\ExpenseCollection();
     ...
     * {@inheritdoc}
     */
    public function SaveExpense(array $ctx, \AutoNotes\Server\Expense $in): \AutoNotes\Server\Expense
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes.server');
        $ctx = Context::withServiceName($ctx, 'OrderRepository');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.OrderRepository/SaveExpense';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.OrderRepository/SaveExpense';
        }
