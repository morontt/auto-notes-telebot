...
/**
 * @internal CarRepositoryAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class CarRepositoryAbstractClient
{
    /**
     * @var string
     */
     ...
     * {@inheritdoc}
     */
    public function GetServices(array $ctx, \AutoNotes\Server\ServiceFilter $in): \AutoNotes\Server\ServiceCollection
    {
        ...
        $out = new \AutoNotes\Server\ServiceCollection();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.CarRepository/GetServices';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.CarRepository/GetServices';
        }
    ...
    public function SaveService(array $ctx, \AutoNotes\Server\Service $in): \AutoNotes\Server\Service
    {
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.CarRepository/SaveService';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.CarRepository/SaveService';
        }
     ...
     * {@inheritdoc}
     */
    public function GetMileages(array $ctx, \AutoNotes\Server\MileageFilter $in): \AutoNotes\Server\MileageCollection
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes.server');
        $ctx = Context::withServiceName($ctx, 'CarRepository');
        $ctx = Context::withMethodName($ctx, 'GetMileages');

        $out = new \AutoNotes\Server\MileageCollection();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.CarRepository/GetMileages';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.CarRepository/GetMileages';
        }
     ...
     * {@inheritdoc}
     */
    public function SaveMileage(array $ctx, \AutoNotes\Server\Mileage $in): \AutoNotes\Server\Mileage
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes.server');
        $ctx = Context::withServiceName($ctx, 'CarRepository');
        $ctx = Context::withMethodName($ctx, 'SaveMileage');

        $out = new \AutoNotes\Server\Mileage();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/xelbot.com.autonotes.server.CarRepository/SaveMileage';
        } else {
            $url = $url.'/'.$this->prefix.'/xelbot.com.autonotes.server.CarRepository/SaveMileage';
        }
