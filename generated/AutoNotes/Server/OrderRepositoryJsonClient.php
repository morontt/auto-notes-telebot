...
/**
 * A JSON client that implements the {@see OrderRepository} interface.
 ...
 */
final class OrderRepositoryJsonClient extends OrderRepositoryAbstractClient implements OrderRepository
{
    /**
     * @inheritDoc
     */
