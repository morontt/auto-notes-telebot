...
abstract class AuthAbstractClient
{
     ...
     * {@inheritdoc}
     */
    public function GetToken(array $ctx, \AutoNotes\LoginRequest $in): \AutoNotes\LoginResponse
    {
        ...
        $out = new \AutoNotes\LoginResponse();
     ...
     * {@inheritdoc}
     */
    public function RefreshToken(array $ctx, \AutoNotes\RefreshTokenRequest $in): \AutoNotes\LoginResponse
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes');
        $ctx = Context::withServiceName($ctx, 'Auth');
