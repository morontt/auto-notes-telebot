 ...
 */
final class AuthServer implements
    ...
    ServerWithPathPrefix
{
     ...
     */
    public const PATH_PREFIX = '/twirp/xelbot.com.autonotes.auth.Auth/';
    ...
    {
        return $this->prefix.'/xelbot.com.autonotes.auth.Auth/';
    }
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        if ($service != 'xelbot.com.autonotes.auth.Auth') {
    ...
    private function handleGetTokenJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \AutoNotes\Auth\LoginRequest();
    ...
    private function handleRefreshTokenJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \AutoNotes\Auth\RefreshTokenRequest();
            $in->mergeFromJsonString((string)$req->getBody(), true);
