...
abstract class UserRepositoryAbstractClient
{
     ...
     * {@inheritdoc}
     */
    public function GetCars(array $ctx, \Google\Protobuf\GPBEmpty $in): \AutoNotes\CarCollection
    {
        ...
        $out = new \AutoNotes\CarCollection();
     ...
     * {@inheritdoc}
     */
    public function GetCurrencies(array $ctx, \Google\Protobuf\GPBEmpty $in): \AutoNotes\CurrencyCollection
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes');
        $ctx = Context::withServiceName($ctx, 'UserRepository');
        $ctx = Context::withMethodName($ctx, 'GetCurrencies');

        $out = new \AutoNotes\CurrencyCollection();
     ...
     * {@inheritdoc}
     */
    public function GetDefaultCurrency(array $ctx, \Google\Protobuf\GPBEmpty $in): \AutoNotes\DefaultCurrency
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes');
        $ctx = Context::withServiceName($ctx, 'UserRepository');
        $ctx = Context::withMethodName($ctx, 'GetDefaultCurrency');

        $out = new \AutoNotes\DefaultCurrency();
     ...
     * {@inheritdoc}
     */
    public function GetUserSettings(array $ctx, \Google\Protobuf\GPBEmpty $in): \AutoNotes\UserSettings
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes');
        $ctx = Context::withServiceName($ctx, 'UserRepository');
        $ctx = Context::withMethodName($ctx, 'GetUserSettings');

        $out = new \AutoNotes\UserSettings();
     ...
     * {@inheritdoc}
     */
    public function SaveUserSettings(array $ctx, \AutoNotes\UserSettings $in): \AutoNotes\UserSettings
    {
        $ctx = Context::withPackageName($ctx, 'xelbot.com.autonotes');
        $ctx = Context::withServiceName($ctx, 'UserRepository');
